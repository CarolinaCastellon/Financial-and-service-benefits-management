...
def main():
    ...
    benefit1 = Benefit("1", "Beneficio 1", "Descuento en compras, Obtén un 10% de descuento en todas tus compras", 0.10)
    benefit_transaction1 = BenefitTransaction("1", user1.user_id, benefit1.benefit_id, datetime.now())
    benefit_provider1 = BenefitProvider("1", "BeneficiosCorp")
